...
lda #$05	; sprite color 1
sta $d028

lda #$05	; sprite color 2
sta $d029

lda #$05	; sprite color 3
sta $d02a
...
lda #$30    ; $d000 corresponds to X-Coord (0-504 incl 9th Bit on PAL systems)
sta $d001   ; $d001 corresponds to Y-Coord (0-255 on PAL systems)

; sprite 1
lda #$20 	; set Sprite#0 positions with X/Y coords to
sta $d002   ; lower right of the screen
lda #$5a    ; $d000 corresponds to X-Coord (0-504 incl 9th Bit on PAL systems)
sta $d003   ; $d001 corresponds to Y-Coord (0-255 on PAL systems)

; sprite 2
lda #$20 	; set Sprite#0 positions with X/Y coords to
sta $d004   ; lower right of the screen
lda #$84    ; $d000 corresponds to X-Coord (0-504 incl 9th Bit on PAL systems)
