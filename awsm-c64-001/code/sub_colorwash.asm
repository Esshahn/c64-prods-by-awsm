...
cycle2     lda color2-1,x     ; Start cycle by fetching previous color in the table...
           ...
           sta colram+10*line-1,x
           sta colram+24*line-1,x
           sta colram+16*line-1,x
...
hearts     lda #$02
           sta colram+10*line+$11
           sta colram+10*line+$12
           sta colram+10*line+$13
           sta colram+10*line+$25
           sta colram+10*line+$26
           sta colram+10*line+$27
